...
class DB
{
  ...
  public static function insert($table, $args = [])  {
    ...
    return self::run("INSERT INTO $table (".implode(', ', array_keys($args)).") VALUES (".implode(', ', $args).")");
  }
   ...
   * @return PDOStatement
   */
  public static function update($table, $args = [], $condition)  {
    foreach ($args as $col => $value) {
      $args[$col] = "$col = '".$value."'";
    }
    return self::run("UPDATE $table SET ".implode(', ', $args)." WHERE $condition");
  }
